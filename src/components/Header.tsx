...
export default class Header extends Component {
  render() {
    ...
    return (
      <>
        <nav className="border-gray-200 fixed z-50 w-screen hidden md:block">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
              <span className="self-center text-2xl font-semibold whitespace-nowrap">Splite</span>
            </a>
            <button
              ...
              <ul
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    className="block py-2 px-3 text-gray-900 rounded md:hover:bg-transparent md:border-0 md:hover:text-[#316FA5] md:p-0"
                  >
                    Blog
                  </a>
                </li>
